    ...
    final BottomNavigationBar botNavBar = new BottomNavigationBar(
        items: [
          new BottomNavigationBarItem(
            icon: new Icon(
              Icons.home,
              color: currentPosition == 0 ? Colors.blue : Colors.black87,
            ),
            title: new Text(
              "主页",
              style: new TextStyle(
          ...
          new BottomNavigationBarItem(
            icon: new Icon(
              Icons.widgets,
              color: currentPosition == 1 ? Colors.blue : Colors.black87,
            ),
            title: new Text(
              "知识体系",
              style: new TextStyle(
          ...
          new BottomNavigationBarItem(
            icon: new Icon(
              Icons.work,
              color: currentPosition == 2 ? Colors.blue : Colors.black87,
            ),
            title: new Text(
              "项目",
              style: new TextStyle(
          ...
          new BottomNavigationBarItem(
            icon: new Icon(
              Icons.person,
              color: currentPosition == 3 ? Colors.blue : Colors.black87,
            ),
            title: new Text(
              "个人中心",
              style: new TextStyle(
